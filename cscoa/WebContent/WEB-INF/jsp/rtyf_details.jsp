...
<body>
	<div data-role="page" id="page2">
		...
		<div data-role="header" data-position="fixed">
			<a href="RTyfAudit?pagenum=0" data-ajax="false" class="back" data-role="none"
...
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.revcompanyname eq null?"":"收款单位:" }${details.revcompanyname }
		</label>
	</td>	
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.paychecksign eq null?"":"是否代付:" }${details.paychecksign==1?"是":"否" }
		</label>
	</td>
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.paytype eq null?"":"支付方式:" }${details.paytype}
		</label>
	</td>
</tr>
<tr>
...
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.feekink eq null?"":"费用类别:" }${details.feekink }
		</label>
	</td>	
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.revtype eq null?"":"费用分组:" }${details.revtype==1?"租金物业":"水电费用" }
		</label>
	</td>
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.payee eq null?"":"员工:" }${details.payee }    ${details.payeename }
		</label>
	</td>	
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.prepaydate eq null?"":"预付日期:" }${details.prepaydate }
		</label>
	</td>	
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.preclosedate eq null?"":"预计冲帐日:" }${details.preclosedate }
		</label>
	</td>	
</tr>
<c:if test="${!empty details.prepayno }">
	...
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.rentno eq null?"":"租约代码:" }${details.rentno}
		</label>
	</td>
</tr>
<tr>
...
<!-- 子表显示 -->	
<hr>
<c:forEach items="${requestScope.rtm00101 }" var="rtm00101">
<table>
<%-- <tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.feecompanyname eq null?"":"付款收款单位:" }${rtm00101.feecompanyname }
		</label>
	</td>	
</tr>
<tr> --%>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.itemname eq null?"":"收款月份:" }${rtm00101.itemname }
		</label>
	</td>	
</tr>
...
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.deptname eq null?"":"费用类别:" }${rtm00101.deptname }
		</label>
	</td>	
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.deptno eq null?"":"费用类别no:" }${rtm00101.deptno }
		</label>
	</td>	
</tr>
<tr>
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.amount eq null?"":"金额:" }${rtm00101.amount}
		</label>
	</td>
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.taxamt eq null?"":"税额:" }${rtm00101.taxamt}
		</label>
	</td>
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.totalamount eq null?"":"去税金额:" }${rtm00101.totalamount}
		</label>
	</td>
</tr>
...
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.invoiceno eq null?"":"发票号码:" }${rtm00101.invoiceno}
		</label>
	</td>
</tr>
<tr>
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.feecompanyname eq null?"":"收款单位:" }${rtm00201.feecompanyname}
		</label>
	</td>
</tr>
<tr>
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.bank eq null?"":"开户银行:" }${rtm00101.bank}
		</label>
	</td>
</tr>
<tr>
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.invoiceno eq null?"":"账号:" }${rtm00101.invoiceno}
		</label>
	</td>
</tr> 
...
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00101.remark eq null?"":"说明:" }${rtm00101.remark}
		</label>
	</td>
</tr>
</table>
	...
	<div data-role="popup" id="popupParis5" data-overlay-theme="b" data-theme="b" data-corners="false">
		...
		<div data-role="header" data-theme="a" class="ui-corner-top">
			...
			<div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
				...
				<form id="form_1" action="agreeRTYF?checkid=${details.checkid }" method="post">
		...
		<div data-role="header" data-theme="a" class="ui-corner-top">
			...
			<div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
				<form id="form_2" action="disagreeRTYF?checkid=${details.checkid }" method="post">
					<textarea cols="30" rows="5" name="replyMessage"></textarea>			
					<div align="center" style="display: none;"><span style="color:red">您没有输入内容!</span></div>
					<br>
					<!-- 取消以及确定按钮，确认按钮点击后则将输入数据保存在数据库中 -->
