...
<body>
	<div data-role="page" id="page2">
		...
		<div data-role="header" data-position="fixed">
			<a href="TravelAudit?pagenum=0" data-ajax="false" class="back" data-role="none"
...
<hr>
<c:forEach items="${requestScope.exm00103 }" var="exm00103">
<table>
<tr>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00103.hourarea eq null?"":"起讫地点:" }${exm00103.hourarea}
		</label>
	</td>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00103.payoutno eq null?"":"费用代码:" }${exm00103.payoutno}
		</label>
	</td>
</tr>
<tr>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00103.amount eq null?"":"金额:" }${exm00103.amount}
		</label>
	</td>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00103.remark eq null?"":"备注(其它币种换算):" }${exm00103.remark}
		</label>
	</td>
</tr>
<tr>
	<td colspan="2" >
		<label style="font-size:13px;color:#bf2020;">
			${exm00103.traveldate eq null?"":"日期:" }${exm00103.traveldate}
		</label>
	</td>
</tr>
</table>
