...
<script type="text/javascript">
 ...
 /* 获取当前时间,并且添加时间控件 */
	...
	function chaxun(a){
		...
		location.href = "searchByCondition?condition="+pandian;
	}
...
<div data-role="page" id="page2">
		...
		<div data-role="content" id="ndchaxun">
			...
			<div align="right">
				<p>
					<a data-role="button" onclick="chaxun(1)">查询<span class="ui-li-count">${size }</span></a>
				</p>
			</div>
 ...
 <script type="text/javascript">
	function goto(checkid){
		location.href = "detailsCol?checkid="+checkid;
	}
</script> 
