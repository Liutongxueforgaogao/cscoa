...
$(function() {
	...
	function chaxun(a){
		...
		location.href = "temp_searchByCondition?condition="+pandian;
	}
...
<div data-role="page" id="page2">
		...
		<div data-role="header" data-position="fixed">
			<a href="TempAudit?pagenum=0" data-ajax="false" class="back" data-role="none"
		...
		<div data-role="content" id="ndchaxun">
			...
			<div align="right">
				<p>
					<a data-role="button" onclick="chaxun(1)">查询<span class="ui-li-count">${temp_size }</span></a>
				</p>
			</div>
 ...
 <script type="text/javascript">
	function goto(checkid){
		location.href = "temp_details?checkid="+checkid;
	}
</script> 
