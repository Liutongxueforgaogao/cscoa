...
$(function() {
	...
	function chaxun(a){
		...
		location.href = "searchByConditionSdzf?condition="+pandian;
	}
...
<div data-role="page" id="page2">
		...
		<div data-role="content" id="ndchaxun">
			...
			<div align="right">
				<p>
					<a data-role="button" onclick="chaxun(1)">查询<span class="ui-li-count">${sdzf_size }</span></a>
				</p>
			</div>
