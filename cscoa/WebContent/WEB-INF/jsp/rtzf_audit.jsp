...
<!-- ================================20170426==================================== -->
		...
		<div data-role="content" id="pdadd">
				...
				<ul data-role="listview" id="auditlist" data-theme="a">
					<!-- 放listview的内容 -->
					<li ><a href="searchtoRTYS" target="_top" class="ui-icon-search" data-ajax="false">条件查询</a></li>
<!-- 
<li ><a href="RTzfAuditMulti?pagenum=0" target="_top" class="ui-icon-search" data-ajax="false">批量审批</a></li>
 -->
