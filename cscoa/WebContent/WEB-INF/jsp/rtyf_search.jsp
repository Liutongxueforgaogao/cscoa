...
$(function() {
	...
	function chaxun(a){
		...
		location.href = "searchByConditionRTYF?condition="+pandian;
	}
...
<div data-role="page" id="page2">
		...
		<div data-role="content" id="ndchaxun">
			...
			<div align="right">
				<p>
					<a data-role="button" onclick="chaxun(1)">查询<span class="ui-li-count">${rtyf_size }</span></a>
				</p>
			</div>
 ...
 <script type="text/javascript">
	function goto1(checkid){
		location.href = "detailsRTYF?checkid="+checkid;
	}
</script> 
