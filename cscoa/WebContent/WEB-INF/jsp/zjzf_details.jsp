...
<body>
	<div data-role="page" id="page2">
		...
		<div data-role="header" data-position="fixed">
			<a href="ZjzfAudit?pagenum=0" data-ajax="false" class="back" data-role="none"
...
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.ym eq null?"":"付款月份:" }${details.ym }
		</label>
	</td>	
</tr>
<tr>
...
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.prepaydate eq null?"":"预期付款日期:" }${details.prepaydate}
		</label>
	</td>
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.preclosedate eq null?"":"预定冲账日期:" }${details.preclosedate}
		</label>
	</td>
</tr>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${details.paydate eq null?"":"付款日:" }${details.paydate}
		</label>
	</td>
</tr>
...
<!-- 子表显示 -->	
<hr>
<c:forEach items="${requestScope.rtm00201 }" var="rtm00201">
<table>
<%-- <tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.feecompanyname eq null?"":"付款收款单位:" }${rtm00201.feecompanyname }
		</label>
	</td>	
</tr> --%>
<tr>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.itemname eq null?"":"收款月份(类别)(部门):" }${rtm00201.itemname }(${rtm00201.subjectname })(${rtm00201.deptname })
		</label>
	</td>	
</tr>
...
<tr>
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.amount eq null?"":"金额:" }${rtm00201.amount}
		</label>
	</td>
</tr>
...
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.bank eq null?"":"开户银行:" }${rtm00201.bank}
		</label>
	</td>
</tr>--%>
...
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.invoiceno eq null?"":"账号:" }${rtm00201.invoiceno}
		</label>
	</td>
</tr> 
<tr>
<td >
		<label style="font-size:13px;color:#bf2020;">
			${rtm00201.remark eq null?"":"说明:" }${rtm00201.remark}
		</label>
	</td>
</tr>
</table>
	...
	<div data-role="popup" id="popupParis5" data-overlay-theme="b" data-theme="b" data-corners="false">
		...
		<div data-role="header" data-theme="a" class="ui-corner-top">
			...
			<div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
				...
				<form id="form_1" action="agreeZjzf?checkid=${details.checkid }" method="post">
		...
		<div data-role="header" data-theme="a" class="ui-corner-top">
			...
			<div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
				<form id="form_2" action="disagreeZjzf?checkid=${details.checkid }" method="post">
					<textarea cols="30" rows="5" name="replyMessage"></textarea>			
					<div align="center" style="display: none;"><span style="color:red">您没有输入内容!</span></div>
					<br>
					<!-- 取消以及确定按钮，确认按钮点击后则将输入数据保存在数据库中 -->
