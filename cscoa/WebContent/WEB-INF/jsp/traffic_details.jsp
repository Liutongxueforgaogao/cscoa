...
<body>
	<div data-role="page" id="page2">
		...
		<div data-role="header" data-position="fixed">
			<a href="TrafficAudit?pagenum=0" data-ajax="false" class="back" data-role="none"
...
<hr>
<c:forEach items="${requestScope.exm00102 }" var="exm00102">
<table>
<tr>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.payoutno eq null?"":"费用代码:" }${exm00102.payoutno}
		</label>
	</td>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.selocation eq null?"":"行程起止地点:" }${exm00102.selocation}
		</label>
	</td>
</tr>
<tr>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.distance eq null?"":"公里数:" }${exm00102.distance}
		</label>
	</td>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.mans eq null?"":"人数:" }${exm00102.mans}
		</label>
	</td>
</tr>
<tr>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.subject eq null?"":"事由:" }${exm00102.subject}
		</label>
	</td>
	<td width="50%">
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.amount eq null?"":"金额:" }${exm00102.amount}
		</label>
	</td>
</tr>
<tr>
	<td colspan="2" >
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.transportdate1 eq null?"":"日期:" }${exm00102.transportdate1}
		</label>
	</td>
</tr>
<tr>
	<td colspan="2" >
		<label style="font-size:13px;color:#bf2020;">
			${exm00102.hourarea eq null?"":"时间段:" }${exm00102.hourarea}
		</label>
	</td>
</tr>
</table>
