...
<!-- ================================20170426==================================== -->
		...
		<div data-role="content" id="pdadd">
				...
				<ul data-role="listview" id="auditlist" data-theme="a">
					<!-- 放listview的内容 -->
					<li ><a href="sign_searchto" target="_top" class="ui-icon-search" data-ajax="false">条件查询</a></li>
					<li class="ui-body ui-body-c"><fieldset class="ui-grid-c">
						<div class="ui-block-a" style="margin:0 auto;text-align:center">编号</div>
						<div class="ui-block-b" style="margin:0 auto;text-align:center">申请人 </div>
						<div class="ui-block-c" style="margin:0 auto;text-align:center">文件类型 </div>
						<div class="ui-block-d" style="margin:0 auto;text-align:center">文件标题</div>
						</fieldset>
					</li>
					<c:forEach items="${requestScope.audits }" var="audit">
						<li  class="bianse"  onclick="goto('${audit.checkid}')" ><div class="ui-grid-c">
<style type="text/css">
div ul li.bianse:hover {                            
 ...
 cursor: pointer;                             
							...
							<div class="ui-block-a" style="margin:0 auto;text-align:center;"><font size="2" >${audit.onlyshowcheckid }</font></div>
							<div class="ui-block-b" style="margin:0 auto;text-align:center;"><font size="2" >${audit.staff }</font></div>
							<div class="ui-block-c" style="margin:0 auto;text-align:center;"><font size="2" >${audit.filetype }</font></div>
							<div class="ui-block-d" style="margin:0 auto;text-align:center;"><font size="2"  >${audit.header }</font></div>
						</div></li>
					</c:forEach>
				</ul>
			</div>
...
<script type="text/javascript">
	function goto(checkid){
		location.href = "sign_details?checkid="+checkid;
	}
	//分页功能
	var pagenum=0;
	var maxpage=0;
	function pagedown(pagenumin,maxpagein){
		...
		if(pagenum==0){
			...
			pagenum=pagenum-1;
			location.href = "TempAudit?pagenum="+pagenum;
		}
	}
