...
$(function() {
	...
	function chaxun(a){
		...
		location.href = "searchByConditionRTYS?condition="+pandian;
	}
...
<div data-role="page" id="page2">
		...
		<div data-role="content" id="ndchaxun">
			...
			<div align="right">
				<p>
					<a data-role="button" onclick="chaxun(1)">查询<span class="ui-li-count">${rtys_size }</span></a>
				</p>
			</div>
			<ul data-role="listview" id="auditlist" data-inset="true" data-theme="a">
			<li class="ui-body ui-body-c"><fieldset class="ui-grid-c">
						<div class="ui-block-a" style="margin:0 auto;text-align:center">日期</div>
						
						<div class="ui-block-b" style="margin:0 auto;text-align:center">申请人</div>
						<div class="ui-block-c" style="margin:0 auto;text-align:center">状态</div>
						<div class="ui-block-d" style="margin:0 auto;text-align:center">备注</div>
						</fieldset>
			</li>
 ...
 <script type="text/javascript">
	function goto1(checkid){
		location.href = "detailsRTYS?checkid="+checkid;
	}
</script> 
