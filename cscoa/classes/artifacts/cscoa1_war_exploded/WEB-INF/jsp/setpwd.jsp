	...
	<div data-role="page" id="page1">
		<div data-role="content" id="navigation">
			...
			<div data-role="content" >
				...
				<form id="pwd" action="setPassword?t=new Date().getTime()" method="post">  
			        <span>请输入原密码:</span>     
			        ...
			        onclick="javascript:document.getElementById('pwd').submit()">提交修改</a>
            	
			        <!-- <input onclick="changepwd()" type="button" value="提交修改"> -->
		        </form>  
