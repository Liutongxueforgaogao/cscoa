...
<tr>
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${exm00101.deptno eq null?"":"部门:" }${exm00101.deptno}
		</label>
	</td>
	<td colspan="2">
		<label style="font-size:13px;color:#bf2020;">
			${exm00101.deptname eq null?"":"部门名称:" }${exm00101.deptname}
		</label>
	</td>
</tr>
<tr>
	...
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${exm00101.taxamt eq null?"":"税额:" }${exm00101.taxamt}
		</label>
	</td>
	<td >
		<label style="font-size:13px;color:#bf2020;">
			${exm00101.totalamount eq null?"":"去税金额:" }${exm00101.totalamount}
		</label>
	</td>
</tr>
<tr>
