...
import com.hub.dao.SdzfAuditLevelQueryDao;
...
@Service("SdzfAuditQueryServiceImpl")
public class SdzfAuditQueryServiceImpl implements AuditLevelQueryService {

	@Autowired(required = false) 
	private SdzfAuditLevelQueryDao sdzfAuditLevelQueryDao;
	...
	public ArrayList<UserAndSuggest> getAllPeopleSuggest(String systemcode){
		ArrayList<UserAndSuggest> allPeopleSuggest = sdzfAuditLevelQueryDao.getAllPeopleSuggest(systemcode);
...
//					output.add(userSuggest);
	...
	public void insertSuggest(String checkid,String shr,String message,String message1) {
		...
		sdzfAuditLevelQueryDao.insertSuggest(checkid,date,shr,message, message1);
	}
	
	public AuditLevelQuery getAuditLevelQuery(String stepremarks,
			String systemcode) {
		AuditLevelQuery auditLevelQuery = sdzfAuditLevelQueryDao.getAuditLevelQuery(stepremarks, systemcode);
	...
	public Suggestion getSuggest(String checkid, String systemcode) {
		...
		AuditLevelQuery auditLevelQuery = sdzfAuditLevelQueryDao.getAuditLevelQuery(checkid, systemcode);
	...
	public void disagree(String userLevel, String systemcode) {
		sdzfAuditLevelQueryDao.disagree(userLevel, systemcode);
	}

	
	public void agree(String userLevel, String systemcode) {
		sdzfAuditLevelQueryDao.agree(userLevel, systemcode);
	}


	
	public String getStatus(String username, String systemcode) {
		String status = sdzfAuditLevelQueryDao.getStatus(username, systemcode);
		return status;
	}
