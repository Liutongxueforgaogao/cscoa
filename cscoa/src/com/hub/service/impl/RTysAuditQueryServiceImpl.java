...
@Service("RTysAuditQueryServiceImpl")
public class RTysAuditQueryServiceImpl implements AuditLevelQueryService {

	@Autowired(required = false) 
	private RTyanshouAuditLevelQueryDao rTyanshouAuditLevelQueryDao;
	...
	public ArrayList<UserAndSuggest> getAllPeopleSuggest(String systemcode){
		ArrayList<UserAndSuggest> allPeopleSuggest = rTyanshouAuditLevelQueryDao.getAllPeopleSuggest(systemcode);
...
//					output.add(userSuggest);
	...
	public void insertSuggest(String checkid,String shr,String message,String message1) {
		...
		rTyanshouAuditLevelQueryDao.insertSuggest(checkid,date,shr,message, message1);
	}
	
	public AuditLevelQuery getAuditLevelQuery(String stepremarks,
			String systemcode) {
		AuditLevelQuery auditLevelQuery = rTyanshouAuditLevelQueryDao.getAuditLevelQuery(stepremarks, systemcode);
	...
	public Suggestion getSuggest(String checkid, String systemcode) {
		...
		AuditLevelQuery auditLevelQuery = rTyanshouAuditLevelQueryDao.getAuditLevelQuery(checkid, systemcode);
	...
	public void disagree(String userLevel, String systemcode) {
		rTyanshouAuditLevelQueryDao.disagree(userLevel, systemcode);
	}

	
	public void agree(String userLevel, String systemcode) {
		rTyanshouAuditLevelQueryDao.agree(userLevel, systemcode);
	}


	
	public String getStatus(String username, String systemcode) {
		String status = rTyanshouAuditLevelQueryDao.getStatus(username, systemcode);
		return status;
	}
