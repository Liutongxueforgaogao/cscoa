...
import com.hub.dao.ZjzfAuditLevelQueryDao;
...
@Service("ZjzfAuditQueryServiceImpl")
public class ZjzfAuditQueryServiceImpl implements AuditLevelQueryService {

	@Autowired(required = false) 
	private ZjzfAuditLevelQueryDao zjzfAuditLevelQueryDao;
	...
	public ArrayList<UserAndSuggest> getAllPeopleSuggest(String systemcode){
		ArrayList<UserAndSuggest> allPeopleSuggest = zjzfAuditLevelQueryDao.getAllPeopleSuggest(systemcode);
...
//					output.add(userSuggest);
	...
	public void insertSuggest(String checkid,String shr,String message,String message1) {
		...
		zjzfAuditLevelQueryDao.insertSuggest(checkid,date,shr,message, message1);
	}
	
	public AuditLevelQuery getAuditLevelQuery(String stepremarks,
			String systemcode) {
		AuditLevelQuery auditLevelQuery = zjzfAuditLevelQueryDao.getAuditLevelQuery(stepremarks, systemcode);
	...
	public Suggestion getSuggest(String checkid, String systemcode) {
		...
		AuditLevelQuery auditLevelQuery = zjzfAuditLevelQueryDao.getAuditLevelQuery(checkid, systemcode);
	...
	public void disagree(String userLevel, String systemcode) {
		zjzfAuditLevelQueryDao.disagree(userLevel, systemcode);
	}

	
	public void agree(String userLevel, String systemcode) {
		zjzfAuditLevelQueryDao.agree(userLevel, systemcode);
	}


	
	public String getStatus(String username, String systemcode) {
		String status = zjzfAuditLevelQueryDao.getStatus(username, systemcode);
		return status;
	}
