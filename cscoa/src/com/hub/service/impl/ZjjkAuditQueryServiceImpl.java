...
import com.hub.dao.ZjjkAuditLevelQueryDao;
...
@Service("ZjjkAuditQueryServiceImpl")
public class ZjjkAuditQueryServiceImpl implements AuditLevelQueryService {

	@Autowired(required = false) 
	private ZjjkAuditLevelQueryDao zjjkAuditLevelQueryDao;
	...
	public ArrayList<UserAndSuggest> getAllPeopleSuggest(String systemcode){
		ArrayList<UserAndSuggest> allPeopleSuggest = zjjkAuditLevelQueryDao.getAllPeopleSuggest(systemcode);
...
//					output.add(userSuggest);
	...
	public void insertSuggest(String checkid,String shr,String message,String message1) {
		...
		zjjkAuditLevelQueryDao.insertSuggest(checkid,date,shr,message, message1);
	}
	
	public AuditLevelQuery getAuditLevelQuery(String stepremarks,
			String systemcode) {
		AuditLevelQuery auditLevelQuery = zjjkAuditLevelQueryDao.getAuditLevelQuery(stepremarks, systemcode);
	...
	public Suggestion getSuggest(String checkid, String systemcode) {
		...
		AuditLevelQuery auditLevelQuery = zjjkAuditLevelQueryDao.getAuditLevelQuery(checkid, systemcode);
	...
	public void disagree(String userLevel, String systemcode) {
		zjjkAuditLevelQueryDao.disagree(userLevel, systemcode);
	}

	
	public void agree(String userLevel, String systemcode) {
		zjjkAuditLevelQueryDao.agree(userLevel, systemcode);
	}


	
	public String getStatus(String username, String systemcode) {
		String status = zjjkAuditLevelQueryDao.getStatus(username, systemcode);
		return status;
	}
