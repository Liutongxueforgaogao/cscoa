...
@Service("MultiAuditQueryServiceImpl")
public class MultiAuditQueryServiceImpl {

	@Autowired(required = false) 
	private MultiAuditQueryDao multiAuditQueryDao;
	...
	public ArrayList<UserAndSuggest> getAllPeopleSuggest(String systemcode){
		ArrayList<UserAndSuggest> allPeopleSuggest = multiAuditQueryDao.getAllPeopleSuggestMulti(systemcode);
...
//					output.add(userSuggest);
	...
	public void insertSuggest(String checkid,String shr,String message,String message1) {
		...
		multiAuditQueryDao.insertSuggestMulti(checkid,date,shr,message, message1);
	}
	
	public AuditLevelQuery getAuditLevelQuery(String stepremarks,
			String systemcode) {
		AuditLevelQuery auditLevelQuery = multiAuditQueryDao.getAuditLevelQueryMulti(stepremarks, systemcode);
	...
	public Suggestion getSuggest(String checkid, String systemcode) {
		...
		AuditLevelQuery auditLevelQuery = multiAuditQueryDao.getAuditLevelQueryMulti(checkid, systemcode);
	...
	public void disagree(String userLevel, String systemcode) {
		multiAuditQueryDao.disagreeMulti(userLevel, systemcode);
	}

	public void agree(String userLevel, String systemcode) {
		multiAuditQueryDao.agreeMulti(userLevel, systemcode);
	}

	public String getStatus(String username, String systemcode) {
		String status = multiAuditQueryDao.getStatusMulti(username, systemcode);
		return status;
	}
